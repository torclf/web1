var dif = 4; // 난이도
var t = 0; // 클릭횟수는 뭔 클릭횟수야
var kc; // 키보드 무슨 키 눌렀는지
var img = ["4-0.png", "4-1.png", "4-2.png", "4-3.png", "4-4.png", "4-5.png", "4-6.png", "4-7.png", "4-8.png", "4-9.png", "blank4.png"]; // 이미지의 주소
...
document.onkeydown = function(e) { // 파이어폭스 호환을 위하여!
	var result = "";
...
function makeWords() { // 이거 do while 문으로 줄일 수 있더라?(허무)
