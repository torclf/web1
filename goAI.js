...
while(player1=="") {
	alert("이름을 입력 안 하신 것 같소만 :/");
	player1 = prompt("플레이어 1의 이름을 입력해주시오.");
}
var player2 = prompt("플레이어 2의 이름을 입력해주시오.");
while(player2=="") {
	alert("이름을 입력 안 하신 것 같소만 :/");
	player2 = prompt("플레이어 2의 이름을 입력해주시오.");
}
...
function press_key() {
	if(pturn===2) kc = 1;
	else if(event.keyCode>=48 && event.keyCode<=57) kc = event.keyCode-48;
